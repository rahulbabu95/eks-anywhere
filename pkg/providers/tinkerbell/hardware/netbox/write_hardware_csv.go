...
func ReadMachinesBytes(machines []byte) ([]*hardware.Machine, error) {
	var hardwareMachines []*hardware.Machine
...
func WriteToCsv(machines []*hardware.Machine) (*os.File, error) {
